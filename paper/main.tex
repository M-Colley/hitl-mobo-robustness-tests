...
\begin{enumerate}
  ...
  \item \textbf{Where the cost sits.} Deployed regret splits into search loss
    ...
    exact observation, and none of six acquisition-side changes reduced it.
...
and above (Appendix~\ref{app:shiprules}): the trials buy more, the rule is free.
...
opportunity rather than delivering it; it is worth having only where such a
decision is cheaper than a rating, as a field trial or an objective
measurement often is. Three further remedies that cost no rating trials are in
...
main sweep pools four error processes, four magnitudes and both onsets; the
spike column is $0.25\sigma$ from the first rating and the capped column pools
$0.25\sigma$ and $1\sigma$ from the first rating.}
\label{tab:shortlist}
\small
