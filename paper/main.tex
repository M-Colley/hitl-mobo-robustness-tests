...
two responses. On the optimizer's trajectory, error the size of a landscape's own
standard deviation, present from the first rating, costs $14\%$ of the achievable
improvement; on the design a study would deploy it costs $30\%$. Decomposing that
deployed regret into search loss and selection loss shows where the difference
sits: at that magnitude $42\%$ $[34, 50]$ of the cost is selection, the run
having visited a better design than the one it ships, and none of seven
acquisition-side changes reduces it, although augmented expected improvement
recovers $41\%$ of the trajectory cost. What does reduce it is spending trials
on identification: one comparative sitting over the last third of the budget
gains $0.05$ of the achievable improvement, and four trials confirming the result
cut false improvement claims from $16\%$ to $0.5\%$. The expected loss of one
noisy choice among random designs, computable from a ten-trial pilot, explains
half of the variation in cost across landscapes and magnitudes.
\end{abstract}
...
24-worker machine. \todo{repository URL and commit at camera-ready.}
