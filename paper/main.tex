...
rating, $-8.7\%$ for the posterior mean. The reason is structural: the posterior
ranking the visited designs was fitted on the same corrupted ratings. Closing the
term needs \emph{new} information, which is what Section~\ref{sec:budget} spends
trials on.
