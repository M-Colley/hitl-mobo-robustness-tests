...
the rater reports their own precision & +16 {\scriptsize [$-$4, 36]} & +15$^{*}$ {\scriptsize [6, 23]} & +0.2 & $-$0.1 \\
each proposal judged beside the incumbent & $-$18$^{*}$ {\scriptsize [$-$25, $-$12]} & $-$27$^{*}$ {\scriptsize [$-$36, $-$19]} & +0.0 & +0.0 \\
every fifth trial rates a fixed anchor & $-$6 {\scriptsize [$-$23, 14]} & +1 {\scriptsize [$-$8, 10]} & +0.8 & +0.7 \\
the first five proposals rated late & $-$13 {\scriptsize [$-$44, 14]} & +1 {\scriptsize [$-$11, 11]} & +1.6 & +0.2 \\
an acquisition aimed at the ship rule & $-$287$^{*}$ {\scriptsize [$-$366, $-$219]} & $-$107$^{*}$ {\scriptsize [$-$159, $-$64]} & +21.8 & +24.4 \\
